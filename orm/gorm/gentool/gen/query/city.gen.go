...
func newCity(db *gorm.DB, opts ...gen.DOOption) city {
	...
	_city.Countrycode = field.NewString(tableName, "countrycode")
	_city.District = field.NewString(tableName, "district")
	_city.Population = field.NewInt32(tableName, "population")
